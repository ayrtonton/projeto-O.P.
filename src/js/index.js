...
const tripulacao = document.querySelectorAll(".tripulante");
...
botoes.forEach((botao, indice) => {
    botao.addEventListener("click", () => {
        ...
        tripulacao[indice].classList.add("selecionado")
    });
});

function selecionarPersonagem() {
    const personagemSelecionado = document.querySelector(".tripulante.selecionado");
